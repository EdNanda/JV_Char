...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            # inst1= rm.open_resource('USB0::0x05E6::0x2461::04100408::INSTR')
            self.keithley = rm.open_resource(device)
        except:
            device = None
            self.keithley = None
        # try:
    ...
    def create_widgets(self):
        ...
        LTsetup.addWidget(QLabel("Start Voltage (V)"),1,0)
        LTsetup.addWidget(self.volt_start,1,1)
        LTsetup.addWidget(QLabel("End Voltage (V)"),1,2)
        LTsetup.addWidget(self.volt_end,1,3)
        LTsetup.addWidget(QLabel("Step size(V)"),2,0)
        LTsetup.addWidget(self.volt_step,2,1)
        LTsetup.addWidget(QLabel("Averaging points"),2,2)
        LTsetup.addWidget(self.ave_pts,2,3)
        LTsetup.addWidget(QLabel("Integration time (s)"),3,0)
        LTsetup.addWidget(self.int_time,3,1)
        LTsetup.addWidget(QLabel("Settling time (s)"),3,2)
        LTsetup.addWidget(self.set_time,3,3)
        ...
        #TODO: Do back and/or forward, include dark
